...
hl.bind("SUPER + CTRL + F", hl.dsp.exec_cmd("~/.config/hypr/scripts/kde-file-share"), { description = "KDE Connect file sharing" })

-- Scripts
hl.bind("SUPER + SHIFT + A", hl.dsp.exec_cmd("~/.config/hypr/scripts/audio-toggle"), { description = "Audio output toggle" })
hl.bind("SUPER + SHIFT + B", hl.dsp.exec_cmd("~/.config/hypr/scripts/battery-notif"), { description = "Battery status" })
hl.bind("SUPER + CTRL + T", hl.dsp.exec_cmd("~/.config/hypr/scripts/text-snatch"), { description = "Text snatcher from image" })
